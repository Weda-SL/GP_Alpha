...
import { AlertCircle, Plus, Pencil, Trash2, Eye, X } from 'lucide-react';
...
export function WasteIntakeContent() {
  const { user } = useAuth();
  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Waste Plastic Intake</h2>
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {viewingIntake.plastic_type_names.map((type, idx) => (
                      <span key={idx} className="px-3 py-1 bg-blue-100 text-blue-800 rounded-md text-sm">
                        {type}
                      </span>
                    ))}
                  </div>
